...
public class HomeAdapter2 extends RecyclerView.Adapter<HomeAdapter2.HomeViewHolder> {
    ...
    public HomeAdapter2(Context context, List<Evento> eventi) {
    ...
    public void onBindViewHolder(@NonNull HomeViewHolder holder, int position) {
        ...
        holder.categoryTextView.setText(evento.getCategoria());
    }
    ...
    public class HomeViewHolder extends RecyclerView.ViewHolder {
        ImageView imageView;
        TextView nomeTextView, categoryTextView, dataTextView;
